...
def descargar_recibo(liquidacion_id: int, secuencia: int) -> str:
    ...
    for legajo in info_recibo['legajos']:
        ...
        # Original
        c.drawString(coordinates['nombre_x'], coordinates['nombre_y'],
                     f"Nombre: {nombre_completo}")
        c.drawString(coordinates['categoria_x'], coordinates['categoria_y'],
                     f"Categoria: {categoria}")
        c.drawString(coordinates['posicion_x'], coordinates['posicion_y'],
                     f"Posición: {posicion}")
        c.drawString(coordinates['area_x'], coordinates['area_y'],
                     f"Area: {area}")
        c.drawString(coordinates['contrato_x'], coordinates['contrato_y'],
                     f"Contrato: {contrato}")
        c.drawString(coordinates['obra_social_x'], coordinates['obra_social_y'],
                     f"O.Social: {obra_social}")
        draw_text_with_end_coordinate(
            canvas=c,
        ...
        # Duplicate
        c.drawString(coordinates['dupl_nombre_x'], coordinates['nombre_y'],
                     f"Nombre: {nombre_completo}")
        c.drawString(coordinates['dupl_categoria_x'], coordinates['categoria_y'],
                     f"Categoria: {categoria}")
        c.drawString(coordinates['dupl_posicion_x'], coordinates['posicion_y'],
                     f"Posición: {posicion}")
        c.drawString(coordinates['dupl_area_x'], coordinates['area_y'],
                     f"Area: {area}")
        c.drawString(coordinates['dupl_contrato_x'], coordinates['contrato_y'],
                     f"Contrato: {contrato}")
        c.drawString(coordinates['dupl_obra_social_x'], coordinates['obra_social_y'],
                     f"O.Social: {obra_social}")
        draw_text_with_end_coordinate(
            canvas=c,
